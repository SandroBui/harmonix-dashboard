...
import { getRolesV2PageData } from '@/lib/roles-v2-reader'
...
import RolesV2Client from './components/RolesV2Client'
...
export default async function RolesPage({
  ...
  if (isV2) {
    let v2Data
    try {
      v2Data = await getRolesV2PageData(config)
    } catch (err) {
